...
export const WORDING_ZH: IWording = {
	...
	MessageSearch: '搜索消息',
	ThreadForward: '推送话题消息',
	MessagePushFollowUp: '推送加急消息',
	MessageReadUsers: '获取已读用户',
	MessageUrgent: '加急消息',
	MessageReactionAdd: '添加表情回复',
	MessageReactionList: '获取表情回复列表',
	MessageReactionDelete: '删除表情回复',
	BatchMessageSend: '批量发送消息',
	BatchMessageRecall: '批量撤回消息',
	BatchMessageProgress: '查询批量消息进度',
	BatchMessageReadUsers: '获取批量消息已读用户',
	MessagePin: '置顶消息',
	MessageUnpin: '取消置顶',
	MessagePinList: '获取置顶列表',
